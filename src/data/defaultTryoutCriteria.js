// src/data/defaultTryoutCriteria.js
  ...
  categories: [
    ...
    },
    {
      ...
      metrics: [
        ...
        {
          name: "Passing - Overhead",
          description: "Form and accuracy in overhead passing",
          minScore: 1,
          maxScore: 5,
          testMethod: "20 pass test",
          guidelines: {
        ...
        },
        {
          ...
          description: "Form and technical execution",
          minScore: 1,
          maxScore: 5,
          guidelines: {
            1: "Poor form and technique",
            2: "Basic form with inconsistencies",
            3: "Good form and technique",
            4: "Very good form and technique",
            5: "Excellent form and technique"
          }
        },
        {
        ...
        {
          name: "Hitting - Contact",
          description: "Ball contact and control",
          minScore: 1,
          maxScore: 5,
          testMethod: "10 hit test",
          guidelines: {
            1: "0-2 successful hits",
            2: "3-4 successful hits",
            3: "5-6 successful hits",
            4: "7-8 successful hits",
            5: "9-10 successful hits"
          }
        },
        {
        ...
        {
          name: "Blocking - Timing",
          description: "Jump timing and hand position",
          minScore: 1,
          maxScore: 5,
          guidelines: {
            1: "Poor timing",
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          description: "Ability to anticipate and react",
          minScore: 1,
          maxScore: 5,
          guidelines: {
            1: "Poor reading",
    ...
    },
    {
      ...
      metrics: [
        ...
        {
          name: "Leadership",
          description: "Ability to lead and inspire teammates",
          minScore: 1,
          maxScore: 5,
          guidelines: {
            1: "No leadership shown",
            2: "Basic leadership",
            3: "Good leadership",
            4: "Strong leadership",
...
module.exports = defaultTryoutCriteria; 